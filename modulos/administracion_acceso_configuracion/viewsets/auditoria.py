"""ViewSet para AuditorÃ­a multi-tenant.
Permite a administradores (rol exacto: ADMIN) consultar bitÃ¡cora de su empresa.
...
from modulos.administracion_acceso_configuracion.models import Auditoria
from modulos.administracion_acceso_configuracion.serializers import AuditoriaSerializer
from nucleo.permisos import IsCompanyAdmin
from nucleo.paginacion import PaginacionEstandar

class AuditoriaViewSet(viewsets.ReadOnlyModelViewSet):
    """ ViewSet para consultar eventos de auditorÃ­a de la empresa del usuario.
    ENDPOINTS:
    ...
    def get_queryset(self):
        """ AISLAMIENTO MULTI-TENANT: cada usuario solo ve auditorÃ­a de su empresa.
        - Si no autenticado: queryset vacÃ­o (el permiso lo bloquearÃ¡ de todas formas)
        - Si autenticado: solo auditorÃ­a de request.user.empresa. """
    ...
    def resumen(self, request, empresa_slug=None, *args, **kwargs):
        ...
        # Usuarios activos en la auditorÃ­a
